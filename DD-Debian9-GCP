...
# GCP Debian 谷歌云GCP 重装 自动提取ip和网关地址 (ubuntu 为 -u 18.04)
...
sleep 1
bash <(wget --no-check-certificate -qO- 'https://moeclub.org/attachment/LinuxShell/InstallNET.sh')  --ip-addr ${IPv4}  --ip-gate ${GATE}  --ip-mask 255.255.240.0  -v 64 -a  -d    9    
    #    
